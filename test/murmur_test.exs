defmodule MurmurTest do
  ...
  test "x86_32 erlang term" do
    assert hash_x86_32(:test) == 27149028
  end
  ...
  test "x86_128 huge data" do
    assert hash_x86_128("b2622f5e1310a0aa14b7f957fe4246fa", 2147368987) == 0x2435044f7ca7f2cf183e80b51f5fd44c
  end

  test "x86_128 erlang term" do
    assert hash_x86_128(:test) == 193365738630794791587273517168070843204
  end
  ...
  test "x64_128 huge data" do
    assert hash_x64_128("b2622f5e1310a0aa14b7f957fe4246fa", 2147368987) == 0xf982047579beb692f57653a0620f950b
  end

  test "x64_128 erlang term" do
    assert hash_x64_128(:test) == 261489243741046697889268700172115018588
  end
end
